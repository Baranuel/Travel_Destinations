...
import { getDestinations } from "./controllers/Destinations_controller";
...
// database setup
const uri =
  "mongodb+srv://m001-student:m001-mongodb-basics@sandbox.ohvc7rg.mongodb.net/admin";
...
app.put("/destination/:id", async (req, res) => {
  ...
  try {
    ...
    const destination = await client
      .db("travel_destinations")
      .collection("destinations")
      .updateOne({ _id: ObjectId(paramsId) }, { $set: updatedDestination });
